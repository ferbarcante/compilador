...
class RTResult:
    ...
    def should_return(self):
        # Isso diz ao interpretador para "parar o que está fazendo"
        return (
            self.error or
...
class Function(BaseFunction):
    ...
    def execute(self, args):
        ...
        ret_value = res.func_return_value if res.func_return_value else (Number.null if self.should_return_null else value)
